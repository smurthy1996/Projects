...
/**
 * This class is fully implemented.  It is used only by the draw() method in the AbstractSorter 
...
public class Plot {
	...
	private static class MyPanel extends JPanel {
		...
		/**
		 * This method draws the x- and y-axes with the origin at the pixel
		 * position (ox, oy).
		 * 
		 * @param g2
		 */
		...
		private void drawPoint(Graphics2D g2, Point p) {
			// pixel coordinates of the upper left corner of the square
		...
		/**
		 * This method is called automatically when a window is created. Think
		 * of Graphics object as a pen.
		 */
		@Override
		...
		/**
		 * x- or y-coordinate of the center pixel in the square representing a
		 * point with Cartesian x-coordinate or y-coordinate i.
		 * 
		 * @param i
		 * @return
		 */
		...
		/**
		 * minimum x- or y-coordinate of any pixel in the square representing a
		 * point with Cartesian x- or y-coordinate i.
		 * 
		 * @param i
		 * @return
		 */
	...
	private static final int MIN_XY = -50; // minimum Cartesian x- and
											// y-coordinates
